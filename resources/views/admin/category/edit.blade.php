    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                ...
                <h6 class="op-7 mb-2">Category/<a href="{{ route('categories.index') }}">Categories</a> /Edit</h6>
            </div>
        </div>
        ...
        <div class="container mt-5">
            ...
            <form action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data" id="categoryForm">
                ...
                <div class="form-group">
                    <label>Name (De)</label>
                    <input type="text" name="name_de" class="form-control" value="{{ old('name_de', $category->name_de) }}">
                </div>
                <div class="form-group">
                    <label>Name (Fr)</label>
                    <input type="text" name="name_fr" class="form-control" value="{{ old('name_fr', $category->name_fr) }}">
                </div>
                <div class="form-group">
                    <label>Name (Ar)</label>
                ...
                <div class="form-group">
                    <label>Name (Zh)</label>
                    <input type="text" name="name_zh" class="form-control" value="{{ old('name_zh', $category->name_zh) }}">
                </div>
                <div class="form-group">
                    <label>Name (Tr)</label>
                    <input type="text" name="name_tr" class="form-control" value="{{ old('name_tr', $category->name_tr) }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="drop-area" class="drop-area">
                        ...
                        <img id="image-preview" src="{{ asset('storage/' .$category->image) }}" alt="Image Preview" style="margin-top: 10px; max-width: 100%;">
                    </div>
                </div>
        ...
        <script>
            ...
            function handleGalleryFiles(files) {
                for (let i = 0; i < files.length; i++) {
                    const file = files[i];
                    displayGalleryImage(file);
                }
            }

            function displayGalleryImage(file) {
                const reader = new FileReader();
                reader.onload = function (e) {

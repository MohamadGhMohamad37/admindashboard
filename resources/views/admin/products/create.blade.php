    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="categoryForm">
        ...
        <div class="form-group">
            ...
            <div id="drop-area" class="drop-area">
                ...
                <input type="file" name="main_image" id="image" class="form-control" required style="display: none;">
        ...
        <div class="form-group">
            ...
            <div id="pdf-drop-area" class="drop-area">
                ...
                <input type="file" name="pdf_file" id="pdf" class="form-control" accept="application/pdf" required style="display: none;">
                <iframe src="#" id="pdf-preview" style="display: none; margin-top: 10px; max-width: 100%;" frameborder="0"></iframe>
            </div>
        </div>
        <div class="form-group">
            ...
            <div id="video-drop-area" class="drop-area">
                ...
                <input type="file" name="video" id="video" class="form-control" accept="video/*" required style="display: none;">

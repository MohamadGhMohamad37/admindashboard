...
<div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <h3 class="fw-bold mb-3">Create Admin</h3>
                <h6 class="op-7 mb-2">User/<a href="{{route('admin.admins')}}">Admins</a> /Add New</h6>
              </div>
            </div>
            <div class="container mt-5">
    <h1 class="mb-4">Create New Admin</h1>
    ...
    @endif
    <form action="{{ route('admin.storeadmin') }}" method="POST" enctype="multipart/form-data" id="categoryForm">
        @csrf
        ...
        <div class="form-group">
            <input type="text" name="role" hidden value="admin" class="form-control">
        </div>

...
<div class="container">
    ...
    @endif
    <form action="{{ route('subcategories.store') }}" method="POST" enctype="multipart/form-data" id="categoryForm">
        @csrf
        ...
        <div class="form-group">
            ...
            <div id="pdf-drop-area" class="drop-area">
                ...
                <input type="file" name="pdf" id="pdf" class="form-control" accept="application/pdf" required style="display: none;">

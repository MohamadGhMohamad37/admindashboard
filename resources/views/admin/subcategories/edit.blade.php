...
<div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Category/<a href="{{route('subcategories.index')}}">Sub Categories</a> /Edit</h6>
              </div>
            </div>
    ...
    @endif
    <form action="{{ route('subcategories.update', $subcategory->id) }}" method="POST" enctype="multipart/form-data" id="categoryForm">
                @csrf
                @method('PUT')
        ...
        <div class="form-group">
            <label>Name (En)</label>
            <input type="text" name="name_en" value="{{ old('name_en', $subcategory->name_en) }}" class="form-control" >
        </div>
        <div class="form-group">
            <label>Name (De)</label>
            <input type="text" name="name_de" value="{{ old('name_en', $subcategory->name_de) }}" class="form-control">
        </div>
        <div class="form-group">
            <label>Name (Fr)</label>
            <input type="text" name="name_fr" value="{{ old('name_en', $subcategory->name_fr) }}" class="form-control">
        </div>
        <div class="form-group">
            <label>Name (Ar)</label>
            <input type="text" name="name_ar" value="{{ old('name_en', $subcategory->name_ar) }}" class="form-control">
        </div>
        <div class="form-group">
            <label>Name (Zh)</label>
            <input type="text" name="name_zh" value="{{ old('name_en', $subcategory->name_zh) }}" class="form-control">
        </div>
        <div class="form-group">
            <label>Name (Tr)</label>
            <input type="text" name="name_tr" value="{{ old('name_en', $subcategory->name_tr) }}" class="form-control">
        </div>

        <!-- Descriptions in Multiple Languages -->
        <div class="form-group">
            <label>Description (En)</label>
            <textarea name="description_en" id="editor_en" rows="5" class="form-control" >{!! old('description_en', $subcategory->description_en) !!}</textarea>
        </div>
        <div class="form-group">
            <label>Description (De)</label>
            <textarea name="description_de" id="editor_de" class="form-control" rows="3" >{!! old('description_en', $subcategory->description_de) !!}</textarea>
        </div>
        <div class="form-group">
            <label>Description (Fr)</label>
            <textarea name="description_fr" id="editor_fr" class="form-control" rows="3" >{!! old('description_en', $subcategory->description_fr) !!}</textarea>
        </div>
        <div class="form-group">
            <label>Description (Ar)</label>
            <textarea name="description_ar" id="editor_ar" class="form-control" rows="3" >{!! old('description_en', $subcategory->description_ar) !!}</textarea>
        </div>
        <div class="form-group">
            <label>Description (Zh)</label>
            <textarea name="description_zh" id="editor_zh" class="form-control" rows="3" >{!! old('description_en', $subcategory->description_zh) !!}</textarea>
        </div>
        <div class="form-group">
            <label>Description (Tr)</label>
            <textarea name="description_tr" id="editor_tr" class="form-control" rows="3" >{!! old('description_en', $subcategory->description_tr) !!}</textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div id="drop-area" class="drop-area">
                ...
                <img id="image-preview" src="{{ asset('storage/' .$subcategory->image) }}" alt="Image Preview" style=" margin-top: 10px; max-width: 100%;">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div id="pdf-drop-area" class="drop-area">
                ...
                <input type="file" name="pdf" id="pdf" class="form-control" accept="application/pdf" style="display: none;">
                <iframe src="{{ asset('storage/' .$subcategory->pdf_file) }}" id="pdf-preview" style=" margin-top: 10px; max-width: 100%;" frameborder="0"></iframe>
            </div>
        </div>

...
<div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <h3 class="fw-bold mb-3">Sub Categories</h3>
                <h6 class="op-7 mb-2">Category/ Sub Categories</h6>
              </div>
            </div>
            <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">View All Sub Categories</h4>
                      ...
                      >
                        ...
                        @foreach ($subcategories as $subcategory)
                            <tr>
                                ...
                                <td>
                                <img src="{{ asset('storage/' . $subcategory->image) }}" alt="Main Image" width="100" style="cursor: pointer;">
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <iframe src="{{ asset('storage/' . $subcategory->pdf_file) }}" width="300px" frameborder="0"></iframe>
                                    @else
                                    No File PDF
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('categories.show', $subcategory->category_id) }}">{{ $subcategory->category->name_en ?? 'No Result' }}</a>
                                </td>
                                <td>
                                    <a href="{{ route('subcategories.show', $subcategory) }}" class="btn btn-icon btn-round btn-info">
                                      <i class="fa fa-info"></i>
                                    </a> |
                                    <a href="{{ route('subcategories.edit', $subcategory) }}"  class="btn btn-icon btn-round btn-warning">
                                        <i class="icon-note"></i>
                                    </a> |
                                    <a href="{{ route('subcategories.downloadPdf', $subcategory) }}"  class="btn btn-icon btn-round btn-secondary">
                                        <i class="fas fa-file-pdf"></i>
                                    </a> |
                                    <form id="delete-form-{{ $subcategory->id }}" action="{{ route('subcategories.destroy', $subcategory) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" id="alert_demo_{{ $subcategory->id }}" class="btn btn-icon btn-round btn-danger">
